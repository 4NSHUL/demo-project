  ...
  return (
    <main className="app-shell">
      <header className="registry-header">
        ...
        <div className="registry-meta"><span>REGISTER NO.</span><strong>RWA/CR/2026</strong><span className={`mode-pill mode-${storageMode}`}>{storageMode === 'supabase' ? 'Shared community register' : 'Browser demo register'}</span></div>
      </header>
